module.exports = {
    name: 'val5',
    description: 'begin search for valorant queue',
            ...
            if (reaction.message.channel.id === message.channel.id) {
                if (reaction.emoji.name === react_emoji) {
                    ...
                    if (players[4] !== p0) {
                        ...
                        await message.channel.send(players[0] + ', ' + players[1] + ', ' + players[2] + ', ' + players[3] + ', ' + players[4] + ', ' + 'your Valorant lobby of 5 has been created.');
                    }
                }
            } else {
                return;
