module.exports = {
    name: 'lol10',
    description: 'begin search for league of legends in-house',
    async execute(client, message, cmd, args, Discord) {
        ...
        let lolq_embed = new Discord.MessageEmbed()
            .setColor(0xFFC300)
            .setTitle('League of Legends In-House')
            ...
            if (reaction.message.channel.id === message.channel.id) {
                if (reaction.emoji.name === react_emoji) {
                    ...
                    if (players[9] !== p0) {
                        ...
                        await message.channel.send(players[0] + ', ' + players[1] + ', ' + players[2] + ', ' + players[3] + ', ' + players[4] + ', ' + players[5] + ', ' + players[6] + ', ' + players[7] + ', ' + players[8] + ', ' + players[9] + ', ' + 'your League of Legends in-house lobby of 10 has been created.');
                    }
                }
            } else {
                return;
