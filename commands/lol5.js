module.exports = {
    name: 'lol5',
    description: 'begin search for league of legends queue',
    async execute(client, message, cmd, args, Discord) {
        ...
        let lolq_embed = new Discord.MessageEmbed()
            .setColor(0xFFC300)
            .setTitle('League of Legends Queue')
            ...
            if (reaction.message.channel.id === message.channel.id) {
                if (reaction.emoji.name === react_emoji) {
                    ...
                    if (players[4] !== p0) {
                        ...
                        await message.channel.send(players[0] + ', ' + players[1] + ', ' + players[2] + ', ' + players[3] + ', ' + players[4] + ', ' + 'your League of Legends lobby of 5 has been created.');
                    }
                }
            } else {
                return;
