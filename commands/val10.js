module.exports = {
    name: 'val10',
    description: 'begin search for valorant in-house',
    async execute(client, message, cmd, args, Discord) {
        ...
        let valq_embed = new Discord.MessageEmbed()
            .setColor(0xFFC300)
            .setTitle('Valorant In-House')
        ...
        let message_embed = await message.channel.send({embeds: [valq_embed]});
        ...
        client.on('messageReactionAdd', async (reaction, user) => {
            ...
            if (reaction.message.channel.id === message.channel.id) {
                if (reaction.emoji.name === react_emoji) {
                    ...
                    await valq_embed.setDescription('React with ' + react_emoji + ' to join the queue.\n Current player counter: ' + p_counter +
                    '\n 1. ' + players[0] +
                    '\n 2. ' + players[1] +
                    '\n 3. ' + players[2] +
                    '\n 4. ' + players[3] +
                    ...
                    await message_embed.edit({embeds: [valq_embed]});

                    if (players[9] !== p0) {
                        message_embed.delete();
                        await message.channel.send(players[0] + ', ' + players[1] + ', ' + players[2] + ', ' + players[3] + ', ' + players[4] + ', ' + players[5] + ', ' + players[6] + ', ' + players[7] + ', ' + players[8] + ', ' + players[9] + ', ' + 'your Valorant in-house lobby of 10 has been created.');
                    }
                }
            } else {
                return;
